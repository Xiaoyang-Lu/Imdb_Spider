...
class ImdbSpider(scrapy.Spider):
    name = 'imdb_spider'
    start_urls = [
        'http://www.imdb.com/search/title?release_date=1990-01-01,2018-01-01&title_type=feature&user_rating=6.0,10'
    ]
    imdbhome = 'http://www.imdb.com'

    def parse(self, response):
        movie_hrefs = [self.imdbhome+x for x in response.selector.xpath('//h3[@class="lister-item-header"]/a/@href').extract()]
